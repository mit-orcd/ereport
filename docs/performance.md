...
- Binary crawl records — Paths and metadata use a fixed header plus a record stream and (when finalized) a catalog tail (file magic `ERCBIN05`, format version 5). Layout and rejection rules are in [binary-format.md](binary-format.md).
