...
# ---- env snapshot ----------------------------------------------------------
{
  ...
  echo "modes: nowrite=$DO_NOWRITE write=$DO_WRITE  strace=$DO_STRACE perf=$DO_PERF sched=$DO_SCHED  reps=$REPS drop_caches=$DROP_CACHES stat_impl=$ECRAWL_STAT_IMPL"
